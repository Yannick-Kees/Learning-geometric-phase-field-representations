...
for e in [140,130,120,110,100,90,80,70,60,50]:
    ...
    for i in range(NUM_TRAINING_SESSIONS+1):
        ...
        if LOSS == "AT":
            ...
            loss = Phase_loss(network, pointcloud, EPSILON, MONTE_CARLO_SAMPLES, MONTE_CARLO_BALL_SAMPLES, e, MU)
            if (i%10==0):
                report_progress(i, NUM_TRAINING_SESSIONS , loss.detach().cpu().numpy() )
            # report_progress(i, NUM_TRAINING_SESSIONS , loss.detach().cpu().numpy() )
