...
EPSILON = .0001
if LOSS == "MM":
    CONSTANT = 70.0 if not FOURIER_FEATUERS else 50.0 # 14, Modica Mortola
else:
...
network = ParkEtAl(3, [NUM_NODES]*7, [4], FourierFeatures=FOURIER_FEATUERS, num_features = 4, sigma = SIGMA )
network.to(device) 
